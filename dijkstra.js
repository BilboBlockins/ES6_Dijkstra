/*
Author: Brett Hiebert
Description: Javascript Implementation of Dijkstra's Algorithm, with Heap (priority queue), Node, and Graph classes
Use: Finds the shortest distance between two Nodes in a weighted graph and maps all the distances from a Node to any other Node.
Date: 12/11/2018
Licence: MIT
